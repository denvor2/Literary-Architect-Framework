...
test.describe('Section Counters', () => {
  ...
  test('Books counter displays in Sidebar header', async ({ page }) => {
    ...
    const booksCounter = page.locator('h2').filter({ hasText: /Книги \(\d+\)/ });
  ...
  test('Series counter displays in Sidebar header', async ({ page }) => {
    ...
    const seriesCounter = page.locator('h2').filter({ hasText: /Серии \(\d+\)/ });
  ...
  test('Chapters counter displays correctly', async ({ page }) => {
    const chaptersCounter = page.locator('h2').filter({ hasText: /Главы \(\d+\)/ });
  ...
  test('Characters counter displays correctly', async ({ page }) => {
    const charactersCounter = page.locator('h2').filter({ hasText: /Персонажи \(\d+\)/ });
  ...
  test('All counters use consistent styling', async ({ page }) => {
    ...
    const headers = page.locator('h2').filter({ hasText: /Книги|Серии|Главы|Персонажи|Идеи|Корзина/ });
  ...
  test('Counters render on empty workspace', async ({ page }) => {
    ...
    const booksText = await page.locator('h2').filter({ hasText: /Книги \(0\)/ }).textContent();
    const seriesText = await page.locator('h2').filter({ hasText: /Серии \(0\)/ }).textContent();
    const chaptersText = await page.locator('h2').filter({ hasText: /Главы \(0\)/ }).textContent();
  ...
  test('Counter format is consistent (number in parentheses)', async ({ page }) => {
